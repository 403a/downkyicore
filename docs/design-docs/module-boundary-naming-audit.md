...
Verification base: `59e7a1c0e868259e8d56b10276184004e41e01be` plus the Gate 9 network-settings-view working tree
Verification branch: `refactor/network-settings-view-owner`
...
| `src/DownKyi.Desktop` | 338 | 44,006 |
...
| P2 | oversized owners | 2 production files above 500 physical lines | confirmed, decreasing |
