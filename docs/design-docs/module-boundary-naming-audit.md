...
Verification base: `e181659a2552123dfa1c77ab000b974883f08a26` plus the Gate 9 video-detail-view working tree
Verification branch: `refactor/video-detail-view-owner`
...
| `src/DownKyi.Desktop` | 346 | 44,093 |
...
| P2 | oversized owners | 1 production file above 500 physical lines | confirmed, source provenance review pending |
